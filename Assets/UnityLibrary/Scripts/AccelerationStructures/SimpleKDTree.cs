...
{
    /// <summary>
    /// An acceleration structure for finding closest points to a given location.
    /// </summary>
    public class SimpleKDTree
    {

        public SimpleKDTree[] lr;
        ...
        public SimpleKDTree()
        {
            lr = new SimpleKDTree[2];
        }


        //	Make a new tree from a list of points.
        public static SimpleKDTree MakeFromPoints(params Vector3[] points)
        {
        ...
        static SimpleKDTree MakeFromPointsInner(
            int depth,
            ...
            )
        {
            ...
            SimpleKDTree root = new SimpleKDTree();
        ...
        /// <summary>
        /// Retrieve the index of the closest point to given point.
        /// </summary>
        /// <param name="pt"></param>
        /// <returns></returns>
