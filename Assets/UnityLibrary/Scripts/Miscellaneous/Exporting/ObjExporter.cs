...
namespace Miscellaneous.Exporting
{
    public class ObjExporterScript
    {
        ...
        public static string MeshToString(SkinnedMeshRenderer renderer, Transform t)
        {
            var mesh = new Mesh();
            renderer.BakeMesh(mesh);
            return MeshToString(mesh, renderer.sharedMaterials, t);
        }

        public static string MeshToString(MeshFilter mf, Transform t)
        {
            return MeshToString(mf.sharedMesh, mf.GetComponent<Renderer>().sharedMaterials, t);
        }
    ...
    public class ObjExporter : ScriptableObject
    {
        ...
        public static void DoExport(bool makeSubmeshes)
        {
            ...
            DoExport(makeSubmeshes, fileName);
        }

        public static void DoExport(bool makeSubmeshes, string file_path)
        {
            if (Selection.gameObjects.Length == 0)
            {
                Debug.Log("Didn't Export Any Meshes; Nothing was selected!");
            ...
            WriteToFile(meshString.ToString(), file_path);

            t.position = originalPosition;

            ObjExporterScript.End();
            Debug.Log("Exported Mesh: " + file_path);
        }
        ...
        static string processTransform(Transform t, bool makeSubmeshes)
        {
            ...
            else
            {
                ...
                if (smr)
                {
                    meshString.Append(ObjExporterScript.MeshToString(smr, t));
                }
            }
